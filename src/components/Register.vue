        ...
        <div class="card-body">
          ...
          <form action="" @submit.prevent="onSubmit">
            <div class="form-group">
              ...
              <input type="email" name="" id="email" class="form-control" v-model="email">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="password" name="" id="confirm-password" class="form-control" v-model="confirmPassword">
            </div>
